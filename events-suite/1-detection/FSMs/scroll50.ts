// FSM «Scroll 50» — 1 vez por sesión: el usuario vio la mitad de la página.
  ...
  createFSM<{ depth: number }, Record<string, never>>({
    ...
    states: {
      watching({ depth }) {
        ...
        gateway.emit(BehaviorEventNames.Scroll50, { engaged_seconds: timeSession.getSeconds() });
        return DONE;
      },
    },
